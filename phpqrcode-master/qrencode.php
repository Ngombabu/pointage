 ...
 */
    ...
    class QRencode {
        ...
        /**
         * @var bool $cmyk Added to fix PHP 8.2+ "Creation of dynamic property" deprecation notice
         */
        public $cmyk = false; // <-- LIGNE AJOUTÉE ET CORRIGÉE
        ...
        public static function factory($level = QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmyk = false)
        {
            ...
            // $enc->cmyk = $cmyk; <-- CETTE LIGNE EST MAINTENANT VALIDE
            $enc->cmyk = $cmyk;
